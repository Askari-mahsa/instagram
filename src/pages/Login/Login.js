        ...
        <>
           ...
           <div className="flex flex-col justify-center">
                ...
                <img className="self-center w-48"alt="instagram" src='/i.png'/>
                    ...
                    ><a href='https://www.facebook.com/'><MDBIcon fab icon="facebook" />Continue with Facebook</a></button>
                    ...
                    <form className="bg-white px-8 pt-6 pb-0 mb-0">
                        <div className="mb-2">
                            <input className="bg-gray-100 w-64 py-3 px-3 border-2 border-zinc-200 text-xs
                            text-gray-400 leading-tight focus:outline-none focus:shadow-outline rounded" 
                            id="username" type="text" placeholder="Phone number,username, or email"/>
                        </div>
                        <div>
               ...
               <div className="flex justify-center">
                    <a className='cursor-pointer text-blue-700 text-xs mb-5'>Froget password?</a>
                </div>
                ...
                <div className="flex justify-center">
                    ...
                    <a className='font-semibold cursor-pointer text-blue-700 text-xs'>&nbsp;Sign Up</a>
                </div>
