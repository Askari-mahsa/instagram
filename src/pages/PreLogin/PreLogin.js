    ...
    return (
        <>
           ...
           <div className="flex flex-col justify-center">
                ...
                <p className="text-gray-400 text-center text-xs" >Sign up to see photos and videos from your friends.</p>
            ...
            <div className="flex justify-center">
                <a className="font-semibold cursor-pointer text-blue-700 text-xs">Log in&nbsp;</a>
