                    ...
                    <HeaderSignUp/>
                                    ...
                                    <div className='flex justify-center'>
                                            <form class="flex justify-center self-center mt-2 bg-gray-200">
                                                ...
                                                <input class="block text-[10px] appearance-none bg-transparent p-4 border-none 
                                     ...
                                     <div className='mb-4 flex self-center mt-3 max-w-[250px] overflow-x-auto'>
                                                    ...
                                                    {buttonLable.map((item)=>(
                                                            <button className='border border-gray-400 text-[10px] p-4 
                                                            text-gray-700 mr-3 py-1 px-2 rounded-[5px] leading-tight focus:outline-none'>{item}
                                                         </button>
                                                    ))}
